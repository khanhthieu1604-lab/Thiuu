                ...
                <div class="bg-white dark:bg-[#121212] p-8 rounded-[2rem] shadow-xl border border-gray-100 dark:border-gray-800 text-center relative overflow-hidden">
                    ...
                    <div class="mt-8">
                        <div class="flex items-center justify-center gap-2 mb-4">
                            ...
                            <span class="text-xs text-gray-400 uppercase font-bold">Hoặc thanh toán online</span>
                            <div class="h-px bg-gray-200 dark:bg-gray-700 flex-1"></div>
                        </div>

                        <a href="{{ $vnpayUrl }}" class="block w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/30 transition transform hover:scale-[1.02] flex items-center justify-center gap-2 mb-4">
                            <i class="fa-solid fa-credit-card"></i>
                            <span>THANH TOÁN QUA VNPAY</span>
                        </a>
                        <p class="text-[10px] text-gray-400 text-center mb-6">Hỗ trợ thanh toán qua thẻ ATM, thẻ tín dụng, QR Code</p>
                    </div>

                    {{-- Bank Transfer Confirmation --}}
                    <form action="{{ route('payment.confirm', $booking->id) }}" method="POST" class="mt-4">
                        @csrf
