...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8" id="vehicle-grid-content">
    ...
    <x-ui.card variant="glass" padding="p-0" class="anime-item group h-full !bg-white dark:!bg-[#111] !border-gray-100 dark:!border-white/5 opacity-0 hover:-translate-y-2 hover:shadow-[0_20px_40px_-5px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_20px_40px_-5px_rgba(234,179,8,0.1)] transition-all duration-500"
